...
namespace Cart.BLL.Messaging.Background
{
    public class ServiceBackground : BackgroundService
    {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            var paymentProductRequest = _serviceScopeFactory.CreateScope().ServiceProvider.GetRequiredService<IProductRequestSubscriber>();
            await consumer.Consume();
            await paymentProductRequest.Consume();
        }
    }
}